...
# Each revision consists of digits and may contain leading zeros. Every revision contains at 
# least one character. Revisions are 0-indexed from left to right, with the leftmost revision 
# being revision 0, the next revision being revision 1, and so on. For example 2.5.33 and 0.1 
...
# are considered equal. If a version number does not specify a revision at an index, 
