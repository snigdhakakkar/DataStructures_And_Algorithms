...
public abstract class Q2_Employee {
	
	private Q2_Call currentCall = null;
	protected Q2_Rank rank;
	private Q2_CallHandler callHandler;

	public Q2_Employee(Q2_CallHandler handler) {
		callHandler = handler;
	}

	/* Start the conversation */
	public void receiveCall(Q2_Call call) {
		currentCall = call;
	}
