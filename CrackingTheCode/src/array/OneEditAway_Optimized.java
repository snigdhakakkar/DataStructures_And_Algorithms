...
public class OneEditAway_Optimized {
	...
	public static boolean oneEdit(String first, String second) {
		...
		while (index2 < s2.length() && index1 < s1.length()) {
			...
			if (s1.charAt(index1) != s2.charAt(index2)) {
				/*Ensuring that this is the first difference found */
			...
			index2++; //we need to always move the pointer for longer string
		} 
	...
	public static void main(String[] args) {
		String a = "palee";
		String b = "pale";
		boolean isOneEdit1 = oneEdit(a, b);
